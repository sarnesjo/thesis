...
% s0
\node[var] (S0a0)  [on grid,right=12mm of C0a0]                {$a_0$};
\node[var] (S0b0)  [on grid,below right=8mm and 6mm of S0a0]  {$b_0$};

% c1
\node[var] (C1a0)  [on grid,right=12mm of S0a0]                {$a_0$};
...
\node[var] (S1b1A) [on grid,below  left=8mm and 6mm of S1a1A] {$b_1$};
\node[var] (S1b1B) [on grid,below right=8mm and 6mm of S1a1A] {$b_1$};
